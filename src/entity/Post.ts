...
import { NoBlanckSpaceConstraint } from "../decorators/noBlanckSpaces";
...
export class Post {
  ...
  @MinLength(5, { message: "Título deve ter pelo menos 5 caractéres" })
  @Validate(NoBlanckSpaceConstraint, {
